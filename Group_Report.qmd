...
From the factor analysis results, most industries tend to load positively on the common factors, meaning they move in the same direction as broad market‐driven variation. Mining (B), Finance (H), Services (I), and Transport/Utilities (E) all show positive average loadings on Factor 1, aligning with systematic movements. Retail (G) loads strongly and positively on Factor 2, while Finance (H) and Services (I) also show moderate positive Factor 2 loadings. Factor 3 does not display a dominant industry, but Finance (H) again has modest positive exposure.

No industry shows consistently negative mean loadings, though some subgroups within industries (e.g., a few D and F stocks) display opposite signs, indicating idiosyncratic moves. This highlights heterogeneity within industries: while Finance (H) stocks generally co‐move strongly with the common factors (low uniqueness, positive loadings), industries like D (Manufacturing) and G (Retail) are more mixed, with higher uniqueness and more diverse directions of movement.
